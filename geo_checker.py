#!/usr/bin/env python3
"""GEO Checker v0.1.0 - AI Brand Presence Scanner. MIT License."""
...
def main():
    p = argparse.ArgumentParser(description="GEO Checker - Check if your site is ready for AI search")
